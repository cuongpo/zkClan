...
export interface AgeCheckInterface extends utils.Interface {
  ...
  functions: {
    "addressMapping(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "addressMapping",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface AgeCheck extends BaseContract {
  ...
  functions: {
    addressMapping(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    addressMapping(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
